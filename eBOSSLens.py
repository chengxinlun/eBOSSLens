...
for j in n.arange(len(plate_mjd)):
	...
	c0,c1,wave,flux,ivar,vdisp, synflux,fiberid, RA, DEC, obj_id, obj_class, obj_type, z, zwarning,z_err, spectroflux, rchi2, rchi2diff, zline,npix = load_data(mjd = mjd, plate=plate, BOSS = BOSS, eBOSS = eBOSS, logdir = '/SCRATCH/', BOSS_version = BOSS_v5_7_2 )
